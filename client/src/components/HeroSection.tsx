    ...
    >
      ...
      <div className="relative z-10 container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center min-h-0 lg:min-h-[calc(100vh-4rem)]">
          ...
          <div className="lg:col-span-6 flex justify-center items-end relative w-full mt-6 lg:mt-0">
            <div className="relative flex flex-col items-center justify-end mx-auto">
              {/* Founder Image */}
              <img
                src="/founderpic.png"
                alt="Dharunraj R - Founder & CEO"
                className="w-auto max-w-[300px] sm:max-w-[420px] lg:max-w-[560px] xl:max-w-[640px] h-auto max-h-[48vh] sm:max-h-[60vh] lg:max-h-[85vh] object-contain object-bottom select-none"
              />

              {/* Glassmorphic Founder Card (Centered inside the grid and on the photo) */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.3 }}
                className="absolute bottom-2 sm:bottom-4 lg:bottom-6 left-1/2 -translate-x-1/2 z-30 w-[92%] sm:w-[320px] md:w-[350px]"
              >
                <div className="p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-black/75 backdrop-blur-2xl border border-white/20 shadow-2xl flex items-center justify-between gap-3 sm:gap-4 text-left transition-all duration-300 hover:border-neon-cyan/40 hover:bg-black/90 group">
